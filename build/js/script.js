...
/***/ "./node_modules/instafeed/dist/InstagramFeed.min.js":
/*!**********************************************************!*\
  !*** ./node_modules/instafeed/dist/InstagramFeed.min.js ***!
  \**********************************************************/
/*! no static exports found */
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;function _typeof(a){"@babel/helpers - typeof";return _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(a){return typeof a}:function(a){return a&&"function"==typeof Symbol&&a.constructor===Symbol&&a!==Symbol.prototype?"symbol":typeof a},_typeof(a)}(function(a,b){ true?!(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_FACTORY__ = (b),
...
/***/ "./src/js/components/accordion.component.js":
/*!**************************************************!*\
  !*** ./src/js/components/accordion.component.js ***!
  \**************************************************/
/*! exports provided: default */
...
var accordion = function accordion(element) {
  document.addEventListener('DOMContentLoaded', function () {
    var accordions = document.querySelectorAll(".".concat(element));
    accordions.forEach(function (el) {
      el.addEventListener('click', function (e) {
        var self = e.currentTarget;
        var control = self.querySelector(".".concat(element, "__control"));
        var content = self.querySelector(".".concat(element, "__content"));
...
/***/ "./src/js/components/insta.component.js":
/*!**********************************************!*\
  !*** ./src/js/components/insta.component.js ***!
  \**********************************************/
/*! exports provided: default */
...
/* harmony import */ var instafeed__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! instafeed */ "./node_modules/instafeed/dist/InstagramFeed.min.js");
/* harmony import */ var instafeed__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(instafeed__WEBPACK_IMPORTED_MODULE_12__);
...
var instagram = function instagram() {
  ...
  (function () {
    new instafeed__WEBPACK_IMPORTED_MODULE_12___default.a({
      'username': 'max.denaro',
      'display_profile': false,
      'display_gallery': true,
      'display_captions': true,
      'callback': function callback(data) {
        var instaArray = data.edge_owner_to_timeline_media.edges;
        var newArray = instaArray.slice(0, 5);
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            insta.insertAdjacentHTML('afterbegin', "\n                        <article class=\"instagram__item\">\n                            <a href=\"https://www.instagram.com/".concat(element.shortcode, "/\" target=\"_blank\">\n                                <img src=\"").concat(element.thumbnail_src, "\"\n                                alt=\"").concat(element.accessibility_caption, "\">\n                            </a>\n                        </article>"));
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
/***/ "./src/js/components/quiz.component.js":
/*!*********************************************!*\
  !*** ./src/js/components/quiz.component.js ***!
  \*********************************************/
  ...
  var quizTemplate = function quizTemplate() {
    ...
    var answers = data.answers.map(function (item) {
      if (item.type === 'checkbox') {
        return "\n                    <li class=\"quiz-question__item\">\n                        <label class=\"custom-checkbox quiz-question__label\">\n                            <img src=\"img/sneakph.jpeg\" alt=\"\">\n                            <input type=\"".concat(item.type, "\" class=\"custom-checkbox__field\" data-valid=\"false\" class=\"quiz-question__answer\" name=\"").concat(data.answer_alias, "\" ").concat(item.type == 'text' ? 'placeholder="Введите ваш вариант"' : '', " value=\"").concat(item.type !== 'text' ? item.answer_title : '', "\">\n                            <span class=\"custom-checkbox__content\">").concat(item.answer_title, "</span>\n                        </label>\n                    </li>\n                ");
      } else if (item.type === 'textarea') {
        return "\n                    <label class=\"quiz-question__label\">\n                        <textarea placeholder=\"".concat(item.answer_title, "\" data-valid=\"false\" class=\"quiz-question__message\" name=\"").concat(data.answer_alias, "\" ></textarea>\n                    </label>\n                ");
      } else {
...
/***/ "./src/js/components/rangeslider.component.js":
/*!****************************************************!*\
  !*** ./src/js/components/rangeslider.component.js ***!
  \****************************************************/
...
/* harmony import */ var core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each.js */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var nouislider_dist_nouislider_min__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! nouislider/dist/nouislider.min */ "./node_modules/nouislider/dist/nouislider.min.js");
/* harmony import */ var nouislider_dist_nouislider_min__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(nouislider_dist_nouislider_min__WEBPACK_IMPORTED_MODULE_2__);
...
var rangeslider = function rangeslider() {
  ...
  if (rangeSlider) {
    nouislider_dist_nouislider_min__WEBPACK_IMPORTED_MODULE_2___default.a.create(rangeSlider, {
      start: [500, 999999],
      connect: true,
      step: 1,
      range: {
...
/* harmony import */ var _vendor_modal_vendor__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ../vendor/modal.vendor */ "./src/js/vendor/modal.vendor.js");
/* harmony import */ var swiper__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! swiper */ "./node_modules/swiper/swiper.esm.js");
function _createForOfIteratorHelper(o, allowArrayLike) { var it = typeof Symbol !== "undefined" && o[Symbol.iterator] || o["@@iterator"]; if (!it) { if (Array.isArray(o) || (it = _unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it["return"] != null) it["return"](); } finally { if (didErr) throw err; } } }; }
...
var products = function products() {
  ...
  var prodSlider = new swiper__WEBPACK_IMPORTED_MODULE_24__["default"]('.modal-slider__container', {
    slidesPerView: 1,
    spaceBetween: 20
  });
    ...
    var loadProducts = function loadProducts() {
      ...
      fetch('../assets/data/data.json').then(function (response) {
        ...
        for (var i = 0; i < dataLength; i++) {
          if (i < quantity) {
            var item = data[i];
            catalogList.innerHTML += "\n                                <li class=\"catalog-list__item\">\n                                    <article class=\"product\">\n                                        <div class=\"product__image\"><img src=\"assets/".concat(item.mainImage, "\" alt=\"").concat(item.title, "\"/>\n                                            <div class=\"product__buttons\">\n                                                <button class=\"product__btn btn-reset\" data-graph-path=\"prod-modal\" data-id=\"").concat(item.id, "\" aria-label=\"\u041F\u043E\u043A\u0430\u0437\u0430\u0442\u044C \u0438\u043D\u0444\u043E\u0440\u043C\u0430\u0446\u0438\u044E \u043E \u0442\u043E\u0432\u0430\u0440\u0435\">\n                                                    <svg>\n                                                        <use href=\"img/sprite.svg#show\"></use>\n                                                    </svg>\n                                                </button>\n                                                <button class=\"product__btn js-cart btn-reset\" data-id=\"").concat(item.id, "\"  aria-label=\"\u041F\u043E\u043B\u043E\u0436\u0438\u0442\u044C \u0442\u043E\u0432\u0430\u0440 \u0432 \u043A\u043E\u0440\u0437\u0438\u043D\u0443\">\n                                                    <svg>\n                                                        <use href=\"img/sprite.svg#cart\"></use>\n                                                    </svg>\n                                                </button>\n                                            </div>\n                                        </div>\n                                        <h3 class=\"product__title\">").concat(item.title, "</h3>\n                                        <span class=\"product__price\">").concat(normalPrice(item.price), " \u0440</span>\n                                    </article>\n                                </li>\n                            ");
          }
        }
      }).then(function () {
        cartLogic();
        modal = new _vendor_modal_vendor__WEBPACK_IMPORTED_MODULE_23__["default"]({
        ...
        try {
          var _loop = function _loop() {
            ...
            if (dataItem.id == id) {
              ...
              var preview = dataItem.gallery.map(function (image, index) {
                return "\n                                <div class=\"modal-preview__item ".concat(index === 0 ? 'modal-preview__item--active' : '', "\" tabindex=\"0\" data-index=\"").concat(index, "\">\n                                    <img src=\"").concat(image, "\" alt=\"\">\n                                </div>\n                                ");
              });
  ...
  var printFullPrice = function printFullPrice() {
    return fullPrice.textContent = "".concat(normalPrice(price), " \u0440");
  };

  var printQuantity = function printQuantity(num) {
    return cartCount.textContent = num;
  };
  ...
  var cartLogic = function cartLogic() {
    var productBtn = document.querySelectorAll('.js-cart');
    ...
    miniCartList.addEventListener('click', function (e) {
      if (e.target.classList.contains('mini-product__delete')) {
        ...
        document.querySelector(".js-cart[data-id=\"".concat(id, "\"]")).classList.remove('product__btn--disabled');
        parent.remove();
  ...
  var orderModalSum = document.querySelector('.cart-modal-order__sum span');
  var orderModalShow = document.querySelector('.cart-modal-order__show');
  openOrderModal.addEventListener('click', function () {
    orderModalList.innerHTML = document.querySelector('.mini-cart__list').innerHTML;
  ...
  orderModalShow.addEventListener('click', function () {
    if (window.getComputedStyle(orderModalList).display === 'none') {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_rangeslider_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/rangeslider.component */ "./src/js/components/rangeslider.component.js");
/* harmony import */ var _components_quiz_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/quiz.component */ "./src/js/components/quiz.component.js");
/* harmony import */ var _components_accordion_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/accordion.component */ "./src/js/components/accordion.component.js");
/* harmony import */ var _components_insta_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/insta.component */ "./src/js/components/insta.component.js");
/* harmony import */ var _components_map_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/map.component */ "./src/js/components/map.component.js");
...
/* harmony import */ var simplebar_dist_simplebar__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! simplebar/dist/simplebar */ "./node_modules/simplebar/dist/simplebar.js");
/* harmony import */ var simplebar_dist_simplebar__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(simplebar_dist_simplebar__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _components_cart_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/cart.component */ "./src/js/components/cart.component.js");
...
var GraphModal = /*#__PURE__*/function () {
  ...
  _createClass(GraphModal, [{
    ...
    value: function events() {
      if (this.modal) {
        document.addEventListener('click', function (e) {
          var clickedElement = e.target.closest("[data-graph-path]");

          if (clickedElement) {
            var target = clickedElement.dataset.graphPath;
            var animation = clickedElement.dataset.graphAnimation;
            var speed = clickedElement.dataset.graphSpeed;
            this.animation = animation ? animation : 'fade';
            this.speed = speed ? parseInt(speed) : 300;
            this._nextContainer = document.querySelector("[data-graph-target=\"".concat(target, "\"]"));
            this.open();
            return;
          }
    ...
    value: function open(selector) {
      ...
      if (selector) {
        this.modalContainer = document.querySelector("[data-graph-target=\"".concat(selector, "\"]"));
      }
...
/* harmony default export */ __webpack_exports__["default"] = (GraphModal);
