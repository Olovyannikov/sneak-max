...
(function (root) {
    ...
    function finale(self) {
        ...
        let i = 0, len = self._deferreds.length;
        for (; i < len; i++) {
    ...
    JustValidate.prototype = {
        ...
        getElements: function getElements() {
            ...
            const _loop = function _loop(i, len) {
                ...
                if (item.type === 'radio') {
                    const findElem = _this2.elements.filter(function (item) {
                        if (item.name === name) {
                            return item;
                        }
                    })[0];
         ...
         * @param _ref
         */
        validateRemote: async function validateRemote(_ref) {
        ...
        renderErrors: function renderErrors() {
            ...
            for (const _item in this.result) {
                const message = this.result[_item].message;
